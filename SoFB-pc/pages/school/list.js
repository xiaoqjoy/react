...
import HouseList from '../../layouts/School/List/HouseList';
import { getSearchKeyword, saveSearch } from '../../api/house/assistant/list';
import { getSchoolRoomList } from '../../api/school';
...
export default class AssistantHouseList extends PureComponent {
    ...
    static async getInitialProps({ req, query }) {
        ...
        } = await seoListBytype({ type: 'school' });
        return {
    ...
    _getHouseList = () => {
        ...
        const url = `/xuexiao/${EncodeURL.init(params).urlResult()}`;
